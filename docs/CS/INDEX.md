...
| 문서 | 제목 | 최종수정 |
|---|---|---|
| [20260807_CS대응매뉴얼_배포_설치_통신_업데이트_원격지원.md](20260807_CS대응매뉴얼_배포_설치_통신_업데이트_원격지원.md) 🆕 | 🟢 **CS 대응 매뉴얼 — 배포·설치·통신·업데이트 원격지원** (배포 영역 진실원). 원격지원 중 상담원이 보는 문서 · 증상별 진단 트리 · **파워쉘 복붙 블록 19개**(🟩보기16/🟨되살리기4/🟥변경2) · **과거 사고 전수 54건 표** · 에스컬레이션 기준 · 절대 금지 목록 | 2026-08-07 |
| [20260807_CS보강제안서_사장님결재용.md](20260807_CS보강제안서_사장님결재용.md) 🆕 | 🟢 **CS 보강 제안서 (사장님 결재용)** — 배포 영역에서 아직 비어 있는 **12건** 제안. 🔴최우선=**고객이 전화 걸 곳이 없다**(매뉴얼 결론이 전부 "본사 이관"인데 이관처 미정의) · 보상기준 · 설치전 점검 · 원격도구 · **헌법 #24 책임경계 4건**(특히 "PC 고장 시 자료 손실" 미고지) | 2026-08-07 |
