...
?? .claude/                                (개발 도구)
?? .cursor/                                (개발 도구)
?? docs/개발/erp/next_session_prompt_20260429_domain.md  (어제 봉합 문서)
?? docs/개발/erp/next_session_prompt_20260429_uxui.md
?? docs/운영기록/next_session_prompt_20260430_handoff.md  (이 문서)
?? logs/                                   (로그)
...
docs/운영기록/next_session_prompt_20260430_handoff.md 읽고
