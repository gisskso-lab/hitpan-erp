...
### 기존 자산 정합 점검 결과
- `docs/design/PRD_AI_CS_SYSTEM.md` v1.2 — BYOK 3종(Anthropic/OpenAI/Google), 토큰 풀, 로컬 RAG(ONNX Runtime DirectML), bge-m3 INT8 양자화, 5중 검증 게이트 통과 명시 — 본 설계의 상위 PRD로 유지
...
| 산출물 | 위치 | 상태 |
|---|---|---|
| **본 통합 설계서** | `docs/design/AI_CHATBOT_DESIGN.md` | 2026-06-11 신설 |
| 상위 PRD | `docs/design/PRD_AI_CS_SYSTEM.md` v1.2 | 기존 유지 |
