...
{domainBlock}
    ...
    <div style=""background:#FEF3C7;border:2px solid #F59E0B;border-radius:12px;padding:24px;margin:24px 0;text-align:center;"">
      ...
      <a href=""https://updates.hitpan.kr/packages/HitPan-ERP-Setup-1.2.15.exe""
      ...
      <p style=""margin:12px 0 0;color:#92400E;font-size:12px;"">버전 1.2.15 · Windows 10/11 (64bit)</p>
    </div>
    ...
    <ol style=""margin:0 0 16px 20px;padding:0;font-size:14px;line-height:1.8;color:#374151;"">
      ...
      <li>다운로드된 <code style=""background:#F3F4F6;padding:2px 6px;border-radius:4px;font-family:monospace;"">HitPan-ERP-Setup-1.2.15.exe</code> 파일을 <strong>마우스 우클릭 → 관리자 권한으로 실행</strong>합니다.</li>
