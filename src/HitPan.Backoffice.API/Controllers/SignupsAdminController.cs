...
{domainBlock}
    ...
    <div style=""background:#FEF3C7;border:2px solid #F59E0B;border-radius:12px;padding:24px;margin:24px 0;text-align:center;"">
      ...
      <a href=""https://updates.hitpan.kr/packages/HitPan-ERP-Setup-1.2.6.exe""
        ...
        히트판 ERP 설치 프로그램 (262 MB)
      </a>
      <p style=""margin:12px 0 0;color:#92400E;font-size:12px;"">버전 1.2.6 · Windows 10/11 (64bit)</p>
    </div>
