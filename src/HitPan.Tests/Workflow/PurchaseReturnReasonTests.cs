...
{
    [Fact(DisplayName = "RR-01: CreateRequest ReturnReason nullable 박제")]
    ...
    [Theory(DisplayName = "RR-03: 5종 표준 사유 박제")]
    [InlineData("defect")]
    ...
    [Fact(DisplayName = "RR-04: UpdateRequest도 ReturnReason 박제")]
    ...
    [Fact(DisplayName = "RR-05: ReturnReasonMemo MaxLength(500) attribute 박제")]
