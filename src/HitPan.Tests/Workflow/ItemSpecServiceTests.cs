...
public class ItemSpecServiceTests
{
    ...
    [Fact(DisplayName = "ISS-01: GetByItemAsync — tenantId null 박제 시 ArgumentException")]
    ...
    [Fact(DisplayName = "ISS-02: GetByItemAsync — tenantId 공백 박제 시 ArgumentException")]
    ...
    [Fact(DisplayName = "ISS-03: GetByItemAsync — itemId null 박제 시 ArgumentException")]
    ...
    [Fact(DisplayName = "ISS-04: CreateAsync — SpecValue 공백 박제 시 InvalidOperationException")]
    ...
    [Fact(DisplayName = "ISS-05: CreateAsync — SpecValue 공백문자 박제 시 InvalidOperationException")]
    ...
    [Fact(DisplayName = "ISS-06: UpdateAsync — SpecValue 공백 박제 시 InvalidOperationException")]
